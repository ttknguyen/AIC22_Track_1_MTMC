...
from torchkit.core import INFERENCES
...
from torchkit.core.vision import ImageLoader
from torchkit.core.vision import ImageWriter
from torchkit.core.vision import InterpolationMode
from torchkit.core.vision import resize
from torchkit.core.vision import to_image
...
class Inference:
    ...
    def validate_attributes(self):
        ...
        if self.data_loader is None:
            raise ValueError(f"Invalid data loader.")
        if self.save_image and self.image_writer is None:
            raise ValueError(f"Invalid image writer.")
    ...
    def preprocess(self, images: Arrays) -> tuple[Tensor, Size2T, Size2T]:
        """Preprocessing input.
    ...
    def postprocess(
        self, results: Tensor, size0: Size2T, size1: Size2T
    ) -> np.ndarray:
...
@INFERENCES.register(name="multi_thread_inference")
