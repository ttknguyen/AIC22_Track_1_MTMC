...
TRANSFORMS.register(name="convert_image_dtype",
                    module=transforms.ConvertImageDtype)
...
TRANSFORMS.register(name="linear_transformation",
                    module=transforms.LinearTransformation)
...
TRANSFORMS.register(name="random_adjust_sharpness",
                    module=transforms.RandomAdjustSharpness)
...
TRANSFORMS.register(name="random_auto_contrast",
                    module=transforms.RandomAutocontrast)
...
TRANSFORMS.register(name="random_horizontal_flip",
                    module=transforms.RandomHorizontalFlip)
...
TRANSFORMS.register(name="random_perspective",
                    module=transforms.RandomPerspective)
TRANSFORMS.register(name="random_posterize", module=transforms.RandomPosterize)
TRANSFORMS.register(name="random_resized_crop",
                    module=transforms.RandomResizedCrop)
TRANSFORMS.register(name="random_rotation",  module=transforms.RandomRotation)
TRANSFORMS.register(name="random_sized_crop",
                    module=transforms.RandomSizedCrop)
TRANSFORMS.register(name="random_solarize",  module=transforms.RandomSolarize)
TRANSFORMS.register(name="random_vertical_flip",
                    module=transforms.RandomVerticalFlip)
