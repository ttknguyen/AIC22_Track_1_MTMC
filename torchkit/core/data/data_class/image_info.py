...
from torchkit.core.vision.io import exif_size
from torchkit.core.vision.io import is_bmp_file
from torchkit.core.vision.utils import VISION_BACKEND
from torchkit.core.vision.utils import VisionBackend
...
class ImageInfo:
	...
	def from_file(
		...
		if (shape0[0] <= 1) or (shape0[1] <= 1):
			raise ValueError(f"Image size <= 1 pixel.")
